...
?>
        <!-- Footer -->
        <footer>
            <span id="year-copy"></span> &copy; <strong><a href="http://goo.gl/9QhXQ"><?php echo $template['name'] . ' ' . $template['version']; ?></a></strong> - Crafted with <i class="fa fa-heart text-danger"></i> by <strong><a href="http://goo.gl/vNS3I" target="_blank"><?php echo $template['author'];?></a></strong>
        </footer>
        <!-- END Footer -->
    </div>
    <!-- END Inner Container -->
